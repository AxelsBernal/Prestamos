...
var prestamoController = _interopRequireWildcard(require("../controllers/prestamo.controller.js"));
...
router.get('/mes/:mes/anio/:anio', _authMiddleware.authMiddleware, prestamoController.getMontoTotalPorMes);
